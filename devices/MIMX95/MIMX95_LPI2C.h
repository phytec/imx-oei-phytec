 ...
 * @version 1.0
 * @date 2021-11-16
 * @brief CMSIS Peripheral Access Layer for MIMX95_LPI2C
 *
 * CMSIS Peripheral Access Layer for MIMX95
 */

/* Prevention from multiple including the same memory map */
#if !defined(MIMX95_LPI2C_H_)  /* Check if memory map has not been already included */
#define MIMX95_LPI2C_H_
...
typedef struct
{
    ...
    __I uint32_t MRDROR; /**< Master Receive Data Read Only, offset: 0x78 */
    ...
    __IO uint32_t SCFGR0; /**< Slave Configuration 0, offset: 0x120 */
    ...
    __I uint32_t SRDROR; /**< Slave Receive Data Read Only, offset: 0x178 */
    uint8_t RESERVED_13[132];
    __O uint32_t MTCBR[128]; /**< Master Transmit Command Burst, array offset: 0x200, array step: 0x4 */
 ...
 *  0b1..LPI2C Master treats a received NACK as if it (NACK) was an ACK and the NACK Detect Flag is never set.
 */
 ...
 *  0b1..MSR[SDF] asserts on last STOP condition before LPI2C master is idle (e.g.: the transmit FIFO is empty at the
 * time of the STOP condition).
 */
 ...
 *  0b0..MSR[STF] asserts on START condition provided both I2C bus and LPI2C master are idle (e.g.: any
 *       non-repeated START condition initiated by any other master on the bus but not the LPI2C master).
 *  0b1..MSR[STF] asserts on START condition provided I2C bus is idle (e.g.: any non-repeated START condition
 *       initiated by any master on the bus including the LPI2C master).
 */
 ...
 *  0b1..NACK always generated on address overrun or receive data overrun, otherwise ACK/NACK set by TXNACK.
 */
...
/*! @name MTCBR - Master Transmit Command Burst */
/*! @{ */
...
#define LPI2C_BASE_ADDRS                                                                                           \
    {                                                                                                              \
        0u, LPI2C1_BASE, LPI2C2_BASE, LPI2C3_BASE, LPI2C4_BASE, LPI2C5_BASE, LPI2C6_BASE, LPI2C7_BASE, LPI2C8_BASE \
    }
/** Array initializer of LPI2C peripheral base pointers */
#define LPI2C_BASE_PTRS                                                                  \
    {                                                                                    \
        (LPI2C_Type *)0u, LPI2C1, LPI2C2, LPI2C3, LPI2C4, LPI2C5, LPI2C6, LPI2C7, LPI2C8 \
    }
/** Array initializer of LPI2C peripheral base addresses */
#define LPI2C_BASE_ADDRS_NS                                                                                 \
    {                                                                                                       \
        0u, LPI2C1_BASE_NS, LPI2C2_BASE_NS, LPI2C3_BASE_NS, LPI2C4_BASE_NS, LPI2C5_BASE_NS, LPI2C6_BASE_NS, \
            LPI2C7_BASE_NS, LPI2C8_BASE_NS                                                                  \
    }
/** Array initializer of LPI2C peripheral base pointers */
#define LPI2C_BASE_PTRS_NS                                                                                       \
    {                                                                                                            \
        (LPI2C_Type *)0u, LPI2C1_NS, LPI2C2_NS, LPI2C3_NS, LPI2C4_NS, LPI2C5_NS, LPI2C6_NS, LPI2C7_NS, LPI2C8_NS \
    }
#else
/** Peripheral LPI2C1 base address */
...
#define LPI2C_IRQS                                                                                                \
    {                                                                                                             \
        NotAvail_IRQn, LPI2C1_IRQn, LPI2C2_IRQn, LPI2C3_IRQn, LPI2C4_IRQn, LPI2C5_IRQn, LPI2C6_IRQn, LPI2C7_IRQn, \
            LPI2C8_IRQn                                                                                           \
    }
...
#endif  /* #if !defined(MIMX95_LPI2C_H_) */
